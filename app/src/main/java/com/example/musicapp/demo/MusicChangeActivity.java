...
@SuppressLint("NewApi")
public class MusicChangeActivity extends FragmentActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
	...
	private CircleButton button_close;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_close = (CircleButton)findViewById(R.id.button2);
		...
		button_close.setOnClickListener(button_closed);
	}
	...
	public class PagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "Animation Basic ", "Animation Beta", "Animation Mega", "Animation Refla","Animation Tida"};
	...
	public View.OnClickListener button_closed = new View.OnClickListener() {
		@Override

		public void onClick(View v) {
			Toast.makeText(getBaseContext(), "Button clicked", Toast.LENGTH_SHORT).show();
			startActivity(new Intent(MusicChangeActivity.this, main.class));
		}
	};
